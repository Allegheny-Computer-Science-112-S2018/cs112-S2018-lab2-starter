...
# cs112-S2018-lab2-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 2 in Computer Science 112. Since
...
called `SentencesReverser`, that will produce twenty-six lines of output. More
details about the behavior of this program are provided in the description of
Project P-1.26 in the textbook. Please note that this program will also require
you to read and modify several other Java classes. The programmer is also
...
`SentencesReverser.java` and `TestSentencesReverser.java` files must adhere to
...
For instance, GatorGrader will check to ensure that `SentencesReverser` has
...
textbook, paying close attention to Section 1.3 and 1.9. Please see the course
...
output for the instructor's version of `SentencesReverser`. Please note that
other classes have methods that you must correctly implement to ensure that the
`SentencesReverser` produces the correct output.
...
- `Sentences.java` contains at least nine multi-line comments in the JavaDoc standard.
- `TestSentences.java` contains at least three passing test cases.
- `SentencesReverser.java` contains five `println`s to produce the twenty-six lines
  of output.
- `SentencesReverser.java` correctly uses other methods to reverse the
  sentences.
- Contains a total of three paragraphs of writing, each with at least three
  sentences
- The GitHub repository must contain at minimum five new commits with
  descriptive messages.
- Passes all of the test cases defined in the two JUnit test suites.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-112-S2018/cs112-S2018-lab2-starter.git
```
...
you can go to the [Computer Science 112 Lab 2
Starter](https://github.com/Allegheny-Computer-Science-112-S2018/cs112-S2018-lab2-starter)
